...
@Component({
  selector: 'app-quickpricer-layout',
  templateUrl: './quickpricer-layout.component.html',
  styleUrls: ['./quickpricer-layout.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class QuickpricerLayoutComponent implements OnInit {
