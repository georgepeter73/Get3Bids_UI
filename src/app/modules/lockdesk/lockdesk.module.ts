...
import {NbButtonModule, NbDialogService, NbIconModule, NbInputModule, NbSelectModule, NbSpinnerModule} from '@nebular/theme';
...
@NgModule({
  declarations: [LockdeskHomeComponent, LoanPipelineComponent, LockConfirmationComponent, RateQuoteProductComponent],
  imports: [
    CommonModule, LockdeskRoutingModule, SharedModule, NbButtonModule, AgGridModule.forRoot(), NbInputModule, NbIconModule, NbSpinnerModule, NbSelectModule, RatingModule
  ],
